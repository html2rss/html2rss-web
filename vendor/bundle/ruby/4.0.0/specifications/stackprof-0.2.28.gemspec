# -*- encoding: utf-8 -*-
# stub: stackprof 0.2.28 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/tmm1/stackprof/issues", "changelog_uri" => "https://github.com/tmm1/stackprof/blob/v0.2.28/CHANGELOG.md", "documentation_uri" => "https://www.rubydoc.info/gems/stackprof/0.2.28", "source_code_uri" => "https://github.com/tmm1/stackprof/tree/v0.2.28" } if s.respond_to? :metadata=
