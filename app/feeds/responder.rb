...
require_relative 'rss_renderer'
require_relative 'service'
require_relative '../http/http_cache'
        ...
        class << self
          ...
          def emit_result(target_kind:, identifier:, resolved_source:, result:)
            ...
            emit_failure(
              target_kind:,
              identifier:,
              error: InternalServerError.new(result.error_message || result.message || HttpError::DEFAULT_MESSAGE)
            )
          end
