...
- feed hero icon treatment and primary reader action emphasis
- feed metadata rows
...
- hero stacks icon + title with shared `ui-actions`, then description, stamp, and `ui-actions layout-rail-reading`
