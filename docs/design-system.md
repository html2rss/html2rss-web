...
- Journey copy lives in [frontend/src/copy.ts](../frontend/src/copy.ts) (one string per job).
...
6. Did journey copy go through `frontend/src/copy.ts` instead of a one-off string?
